...
export function Room(props) {
    ...
    // 🔧 OPTIMIZED: Memoize materials for better performance
    ...
    return (
        <group {...props} dispose={null}>
            {/* 🌟 BLOOM EFFECT RESTORED with performance optimizations */}
            <EffectComposer
            ...
            >
                <SelectiveBloom
                    ...
                    intensity={1.2} // Slightly reduced for performance
                    luminanceThreshold={0.3} // Higher threshold = better performance
                    luminanceSmoothing={0.8} // Reduced smoothing
                    blendFunction={BlendFunction.ADD}
                    radius={0.7} // Reduced radius for performance
                />
            </EffectComposer>
